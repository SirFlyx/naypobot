...
exports.run = (bot, message, args) => {
    if (!message.member.hasPermission("BAN_MEMBERS")) return message.channel.send("⚠️ ERRO: Você não possui permissão para kickar!");
    ...
    .setDescription(`Reaja com '✅' para kickar o ${membro}\nPelo Motivo: ${motivo}`)
